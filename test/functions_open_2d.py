...
dist0, area0, length0, euler0 = mk.functions_open(erosion_map0,res0)
dist1, area1, length1, euler1 = mk.functions_open(erosion_map1)
dist2, area2, length2, euler2 = mk.functions_open(erosion_map2,res2)
dist3, area3, length3, euler3 = mk.functions_open(erosion_map3,res3)

area, length, euler = mk.functionals(image1)

plt.plot(0,area,marker="o")
...
dist0, area0, length0, euler0 = mk.functions_open(erosion_map0,res0,norm=True)
dist1, area1, length1, euler1 = mk.functions_open(erosion_map1,norm=True)
dist2, area2, length2, euler2 = mk.functions_open(erosion_map2,res2,norm=True)
dist3, area3, length3, euler3 = mk.functions_open(erosion_map3,res3,norm=True)
