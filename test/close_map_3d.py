...
#plt.gray()
#plt.imshow(dilation_map0[:,:,32],extent=ext0)
#plt.show()
#
#plt.gray()
#plt.imshow(dilation_map1[:,:,64])
#plt.show()
#
#plt.gray()
#plt.imshow(dilation_map2[:,:,128],extent=ext2)
#plt.show()
#
#plt.gray()
#plt.imshow(dilation_map3[:,:,128],extent=ext3)
#plt.show()

# These images should be the same (exept difference caused by resolution)
plt.gray()
plt.imshow(closing_map0[:,:,32],extent=ext0)
plt.show()

plt.gray()
plt.imshow(closing_map1[:,:,64])
plt.show()

plt.gray()
plt.imshow(closing_map2[:,:,128],extent=ext2)
plt.show()

plt.gray()
plt.imshow(closing_map3[:,:,128],extent=ext3)
plt.show()
