...
dist0, volume0, surface0, curvature0, euler0 = mk.functions_open(erosion_map0,res0)
dist1, volume1, surface1, curvature1, euler1 = mk.functions_open(erosion_map1)
dist2, volume2, surface2, curvature2, euler2 = mk.functions_open(erosion_map2,res2)
dist3, volume3, surface3, curvature3, euler3 = mk.functions_open(erosion_map3,res3)
...
dist0, volume0, surface0, curvature0, euler0 = mk.functions_open(erosion_map0,res0,norm=True)
dist1, volume1, surface1, curvature1, euler1 = mk.functions_open(erosion_map1,norm=True)
dist2, volume2, surface2, curvature2, euler2 = mk.functions_open(erosion_map2,res2,norm=True)
dist3, volume3, surface3, curvature3, euler3 = mk.functions_open(erosion_map3,res3,norm=True)
